...
const add = async (req, res) => {
    try {
        ...
        if(updateUser) {
            updateUser.contactsCreated = updateUser.contactsCreated + 1; 
...
const addMany = async (req, res) => {
    try {
        ...
        // if(updateUser) {
        //     updateUser.contactsCreated = updateUser.contactsCreated + (data?.length || 0); 
        //     await updateUser.save(); 
        // }
...
const deleteData = async (req, res) => {
    try {
        ...
        const updateUser = await User.findById(contact.createBy);
        if(updateUser) {
            updateUser.contactsCreated = updateUser.contactsCreated - 1; 
            await updateUser.save(); 
        }
